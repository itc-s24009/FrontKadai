...
このアプリケーションは、Crazy Raccoon SF6部門の軌跡や、所属メンバーの魅力を伝えるための紹介サイトです。チーム全体の歴史を知ることができるページや、microCMSで管理されたデータをもとにしたメンバー個別の詳細ページを閲覧することができます。学校の課題として、フロントエンド技術とCMSを組み合わせを学ぶために制作しました。
...
Next.js (App Router) とHeadless CMS (microCMS) を連携させた、Vercelへのデプロイまでの開発ワークフローの習得を目的としています。
